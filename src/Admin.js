...
theme = responsiveFontSizes(theme);
  ...
  <Navbar.Brand href="#">{posts ? <div>{posts.adminName}</div>: null}</Navbar.Brand>
  <Navbar.Toggle aria-controls="responsive-navbar-nav" />
  <Navbar.Collapse id="responsive-navbar-nav">
    <Nav className="mr-auto">
      
      <Nav.Link href="#pricing">{posts ? <div>ADMIN ID:{posts.adminId}</div> : null}</Nav.Link>
      <Nav.Link href="#pricing">{posts ? <div>PHONE:{posts.adminPhone}</div> : null}</Nav.Link>
